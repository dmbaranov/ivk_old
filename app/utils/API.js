...
export default {
  ...
  getMessage(params, access_token, messageID) {
    return new Promise((resolve, reject) => {
      request(`https://api.vk.com/method/messages.getById?message_ids=${messageID}&access_token=${access_token}`, params, resolve, reject);
    });
  }
}
